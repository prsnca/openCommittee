...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field voting_ministers on 'Meeting'
        m2m_table_name = db.shorten_name(u'committeeVotes_meeting_voting_ministers')
    ...
    def backwards(self, orm):
        # Removing M2M table for field voting_ministers on 'Meeting'
        db.delete_table(db.shorten_name(u'committeeVotes_meeting_voting_ministers'))
    ...
    models = {
        ...
        u'committeeVotes.meeting': {
            ...
            'voting_ministers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['committeeVotes.Minister']", 'symmetrical': 'False', 'blank': 'True'})
        },
