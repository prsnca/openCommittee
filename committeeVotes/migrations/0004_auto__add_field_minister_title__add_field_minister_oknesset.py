...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Minister.title'
        db.add_column(u'committeeVotes_minister', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Minister.oknesset'
        db.add_column(u'committeeVotes_minister', 'oknesset',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Minister.title'
        db.delete_column(u'committeeVotes_minister', 'title')

        # Deleting field 'Minister.oknesset'
        db.delete_column(u'committeeVotes_minister', 'oknesset')
